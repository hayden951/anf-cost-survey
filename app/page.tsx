...
const questions: Question[] = [
  ...
  { category: "Performance & Tiering", badge: "HIGH RISK", text: "When you size your Azure NetApp Files clusters, have you experienced the challenge of provisioning more capacity than you need, just to hit a performance threshold?", answers: [{ label: "Yes, we routinely provision more capacity to achieve the required performance", s: 4 }, { label: "Sometimes, we use different clusters for high-performance and low performance workloads", s: 3 }, { label: "No — we use the tier that matches our performance and capacity needs", s: 1 }, { label: "I don't know", s: 2 }], key: "performance" },
